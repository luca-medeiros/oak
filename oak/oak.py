...
class Oak(Fastdup):
    ...
    def __init__(self,
                 ...
                 coco_annotations: Union[None, str, Path] = None):
...
if __name__ == '__main__':
    oak = Oak('tiny-coco/small_coco/train_2017_small', 'tiny-coco/small_coco/train_2017_smallastdup',
              'tiny-coco/small_coco/coco.json')
